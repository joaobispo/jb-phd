 ...
 * @author Joao Bispo
 */
public class MbBasicBlockIterative extends BasicBlock{

   public MbBasicBlockIterative() {
      super();
      isDelaySlot = false;
   }
   ...
   @Override
   protected boolean isJumpInstruction(GenericInstruction instruction) {
      ...
      if(instName == null) {
         Logger.getLogger(MbBasicBlockIterative.class.getName()).
