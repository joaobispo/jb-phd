 ...
 * @author Joao Bispo
 */
public enum SimulatorOption implements Option {

   string_o_level("string-optimization-level",""),
   iteration_threshold("iteration-threshold","");


   private SimulatorOption(String optionName, String defaultValue) {
